...
class VAAL(Strategy):
    ...
    def train_vaal(self, total_epoch=100, num_vae_steps=2, beta=1, adv_param=1, latent_dim=64, batch_size=10):
        ...
        self.vae = self.net_vae(latent_dim).to(self.device)
        self.dis = self.net_dis(latent_dim).to(self.device)
